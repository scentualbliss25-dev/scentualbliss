export const metadata = {
  ...
  description: 'Política de devoluciones, cambios y reembolsos de ScentualBliss. 30 días de garantía.',
  robots: { index: true },
};
...
const steps = [
  ...
  { n: '02', title: 'Aprobación', desc: 'Revisamos tu caso y te confirmamos si aplica la devolución en un plazo de 24–48 horas hábiles.' },
...
export default function DevolucionesPage() {
  return (
    <main style={{ minHeight: '80vh', background: '#F6F3EE' }}>
      ...
      <div className="container" style={{ padding: '56px 24px', maxWidth: '800px' }}>
        ...
        <div style={{ marginBottom: 56 }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: 24 }}>
            {steps.map(s => (
              <div key={s.n} style={{ padding: '24px', background: '#FFFFFF', borderTop: '2px solid var(--gold)' }}>
        ...
        {/* CTA contacto */}
        <div style={{ padding: '32px', background: '#FFFFFF', borderLeft: '3px solid var(--gold)', marginTop: 40 }}>
      ...
      <style>{`@media(max-width:600px){.container > div > div[style*="grid-template-columns"]{grid-template-columns:1fr !important;}}`}</style>
    </main>
  );
}
