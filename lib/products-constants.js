...
// === Familias olfativas (para filtrar por aroma)
// Las 6 primeras son las "clásicas". Las siguientes se agregaron para
// cubrir términos del inventario que no encajaban en las clásicas
// (ver docs/decisiones de mapeo — julio 2026).
export const collections = [
  ...
  { id: 'especiado',  slug: 'especiados',  name: 'Especiados',  description: 'Calidez picante y envolvente', color: '#A8471E', image: '/img/lattafa-khamrah.webp' },
  { id: 'avainillado',slug: 'avainillados',name: 'Avainillados',description: 'Dulzura cremosa de vainilla', color: '#D9A441', image: '/img/lattafa-khamrah.webp' },
  { id: 'aromatico',  slug: 'aromaticos',  name: 'Aromáticos',  description: 'Notas herbales y especiadas',  color: '#5B8C5A', image: '/img/dior-sauvage-edt.webp' },
  { id: 'ambar',      slug: 'ambar',       name: 'Ámbar',       description: 'Resinas cálidas y envolventes', color: '#C17817', image: '/img/tom-ford-oud-wood.webp' },
  { id: 'marino',     slug: 'marinos',     name: 'Marinos',     description: 'Brisa acuática y salina',      color: '#3E7CB1', image: '/img/dior-sauvage-edt.webp' },
  { id: 'tropical',   slug: 'tropicales',  name: 'Tropicales',  description: 'Exotismo frutal y jugoso',     color: '#16A085', image: '/img/creed-aventus.webp' },
  { id: 'atalcado',   slug: 'atalcados',   name: 'Atalcados',   description: 'Suavidad polvorosa y limpia',  color: '#C9B7A6', image: '/img/chanel-coco-mademoiselle.webp' },
];
