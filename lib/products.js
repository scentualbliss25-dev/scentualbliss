...
//
// Antes este archivo exportaba un array `products` hardcoded con los 155
// productos. Ahora los productos viven en Supabase y se acceden con las
// funciones async re-exportadas desde lib/products-db.js. Las constantes
// (collections, productTypes, etc.) se quedan acá porque son metadata
// fija que no cambia con frecuencia.
//
// Si necesitas el catálogo en código, usa:
//   import { getAllProducts } from '@/lib/products';
//   const products = await getAllProducts();
//
// Para obtener UN producto:
//   import { getProductBySlug } from '@/lib/products';
//   const product = await getProductBySlug('lattafa-khamrah');
//
// El cache vive 5 min en memoria del server. Cuando el admin edita,
// llama a revalidateTag('products') y los cambios aparecen al instante.

// Re-exports de la capa de acceso a datos
export {
  getAllProducts,
  getProductBySlug,
  getProductById,
