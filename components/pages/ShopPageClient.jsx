...
// Lista única de marcas, ordenada alfabéticamente
...
export default function ShopPageClient() {
  ...
  // Estado derivado de la URL — única fuente de verdad
  ...
  // Actualiza un parámetro y navega; si el valor es 'Todos' o vacío, lo elimina
      ...
      <div className="container" style={{ padding: '36px 24px' }}>
          ...
          <div style={{ flex: '1 1 auto' }}>
            ...
            <div style={{ marginBottom: 16 }}>
              ...
              <div className="shop-filter-row">
                {typeCats.map(t => (
                  <button key={t.id} onClick={() => updateParam('type', t.id)} style={{
            ...
            <div style={{ marginBottom: 16 }}>
              ...
              <div className="shop-filter-row">
                {aromaCats.map(c => (
                  <button key={c.id} onClick={() => updateParam('cat', c.id)} style={{
                    padding: '6px 16px', fontSize: '.72rem', fontWeight: 500, letterSpacing: '.1em',
                    textTransform: 'uppercase',
                    border: '1px solid',
            ...
            {/* Marca */}
            <div>
              <p style={{ fontSize: '.6rem', letterSpacing: '.28em', textTransform: 'uppercase', color: 'var(--gold)', fontWeight: 500, marginBottom: 10 }}>Marca</p>
              <div style={{ position: 'relative', maxWidth: 280 }}>
                <select
                  ...
                  style={{
                    ...
                    color: brand !== 'Todos' ? 'var(--gold)' : 'var(--gray)',
                    fontSize: '.78rem', letterSpacing: '.06em',
                ...
                <ChevronDown size={12} style={{ position: 'absolute', right: 10, top: '50%', transform: 'translateY(-50%)', color: 'var(--gold)', pointerEvents: 'none' }} />
              </div>
            </div>
          </div>
        ...
        {filtered.length === 0 ? (
          <div style={{ textAlign: 'center', padding: '100px 0' }}>
            ...
            <button onClick={() => router.push('/tienda')} className="btn btn-outline btn-sm">Limpiar filtros</button>
          </div>
        ) : (
